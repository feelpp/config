...
export FEELPP_BOOST155_PATH=$FEELPP_SHARE_PATH/boost/1.56
...
export FEELPP_PETSC351_OMPI182_GCC_PATH=$FEELPP_SHARE_PATH/petsc/3.5.1_ompi182
...
export FEELPP_SLEPC351_GCC_PATH=$FEELPP_SHARE_PATH/slepc/3.5.1
...
export FEELPP_GMSH285_GCC_PATH=$FEELPP_SHARE_PATH/gmsh/2.8.5
